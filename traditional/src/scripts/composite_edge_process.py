"""
将 grayscale.png、gaussian_blur.png、canny_edge.png、contour_frame.png
四张图片横向拼接成一行，每张小图下方居中标注方法名称。
"""
import os
from PIL import Image, ImageDraw, ImageFont

# 路径设置
base_dir = r"d:/experiment/SingleTrack_Project/results/traditional/GOT-10k_Train_000424/edge_contour"
output_path = os.path.join(base_dir, "edge_process.png")
...
# 对应中文标签
labels = ["灰度图", "高斯滤波", "Canny边缘检测", "轮廓提取"]
