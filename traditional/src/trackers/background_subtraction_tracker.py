...
class BackgroundSubtractionTracker(BaseTracker):
    def __init__(self):
        super().__init__("bg_subtract")
    ...
    def update(self, frame):
        ...
        roi_fg = np.zeros_like(fg)
        roi_fg[y1:y2, x1:x2] = fg[y1:y2, x1:x2]

        cand = self._best_bbox(roi_fg)
