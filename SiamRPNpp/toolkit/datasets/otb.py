    ...
    def load_tracker(self, path, tracker_names=None, store=True):
        ...
        for name in tracker_names:
            ...
            if not os.path.exists(traj_file):
                txt_name_lower = self.name.lower()+'.txt'
                traj_file_lower = os.path.join(path, name, txt_name_lower)
                if os.path.exists(traj_file_lower):
                    traj_file = traj_file_lower
                elif self.name == 'FleetFace':
